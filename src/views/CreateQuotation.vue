  ...
  <Card>
    ...
    <CardContent class="space-y-6">
      <div class="grid grid-cols-2 gap-4">
        <div class="space-y-2">
          <Label class="text-[10px] uppercase tracking-wider font-semibold text-muted-foreground">Quotation Number</Label>
          <Input v-model="form.quotationNumber" />
        </div>
        <div class="space-y-2">
      ...
      <div class="grid grid-cols-2 gap-4">
        <div class="space-y-2">
          <Label class="text-[10px] uppercase tracking-wider font-semibold text-muted-foreground">Date</Label>
          <Input type="date" v-model="form.date" />
        </div>
        <div class="space-y-2">
          <Label class="text-[10px] uppercase tracking-wider font-semibold text-muted-foreground">Valid Until</Label>
...
export default defineComponent({
 ...
 const form = reactive({
 id: '',
 quotationNumber: settingsStore.app.quotationPrefix + Date.now().toString().slice(-6),
 projectName: '',
 ...
 if (quo) {
 isEdit.value = true
 Object.assign(form, JSON.parse(JSON.stringify(quo)))
 }
 } else {
 addItem()
 }
 ...
 const computedQuotation = computed(() => {
