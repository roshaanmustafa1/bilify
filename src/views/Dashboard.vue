        ...
        <CardContent>
          ...
          <div v-else class="space-y-4">
            <div
              ...
              :key="inv.id"
              class="flex items-center justify-between p-4 border rounded-lg dark:border-border"
            >
              <div>
        ...
        <CardContent>
          <div class="grid grid-cols-2 gap-4">
            <button
              ...
              class="p-4 border dark:border-border rounded-lg flex flex-col items-center justify-center gap-2 hover:bg-muted dark:hover:bg-card transition-colors"
            >
            ...
            <button
              @click="openAI"
              class="p-4 border dark:border-border rounded-lg flex flex-col items-center justify-center gap-2 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-colors"
            >
