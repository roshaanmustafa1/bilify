<template>
  ...
  >
    ...
    <div class="mb-12 overflow-x-auto">
      <table class="w-full text-left border-collapse min-w-[500px]">
        <thead>
          <tr>
            <th
              class="py-3 text-xs font-semibold uppercase tracking-widest text-muted-foreground border-b border-border/40 w-1/2"
            >
              Item Description
            </th>
            <th
              class="py-3 text-xs font-semibold uppercase tracking-widest text-muted-foreground border-b border-border/40 text-center"
            >
              Qty
            </th>
            <th
              class="py-3 text-xs font-semibold uppercase tracking-widest text-muted-foreground border-b border-border/40 text-right"
            >
              Rate
            </th>
            <th
              class="py-3 text-xs font-semibold uppercase tracking-widest text-foreground border-b border-border/40 text-right"
            >
              Amount
            </th>
          </tr>
        ...
        <tbody>
          <tr v-for="item in document.items" :key="item.id">
            ...
            <td class="py-5 border-b border-border/20 text-center font-light">
              {{ item.quantity }}
            </td>
            <td
              class="py-5 border-b border-border/20 text-right font-light text-muted-foreground"
            >
              {{ formatCurrency(item.price) }}
            </td>
            <td
              class="py-5 border-b border-border/20 text-right font-medium text-foreground"
            >
    ...
    <!-- Footer Notes -->
    <div
      class="mt-16 pt-8 border-t border-border/40 grid grid-cols-1 md:grid-cols-2 gap-8 text-xs font-light"
    >
